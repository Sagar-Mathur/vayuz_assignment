    ...
    return (
        <div className='service'>
            <div className='service_heading'>
                ...
                <p style={{ fontSize: "22px", fontWeight: "500", fontFamily: "Quicksand", textAlign: "center" }}>Embrace Innovation: Let's Create Together!</p>
            ...
            <div className='service-page' style={{ display: "flex", width: "100%", height: "auto", alignItems: "center" }}>
